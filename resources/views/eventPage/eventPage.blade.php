                        ...
                        <div class="flex outline outline-1 m-2 shadow-sm rounded-sm">
                            <div class="rounded overflow-hidden m-2 flex justify-between">
                                <div class="md:flex-shrink-0">
                                    <a href="">
                                        <img class="md:w-56" src="{{ url('assets/image/') . "/" . $event_akademik->image}}"
                                            alt="A Quiet Place movie poster" />
                                    </a>
                                </div>
                                <div class="flex flex-col flex-grow px-8 py-4 bg-color-333">
                                    <h3 class="font-bold text-4xl md:text-2xl lg:text-2xl text-black">{{ $event_akademik->nama_event }}</h3>
                                    <span class="text-black text-xl lg:text-sm lg:mb-4">{{ $event_akademik->university->nama_universitas }}</span>
                                    <div class="flex-grow">
                                        <p
