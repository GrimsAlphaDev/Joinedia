<x-app-layout>
    ...
    <div class="container-fluid">
        ...
        {{-- Big Hero --}}
        <div class="container-fluid bg-white p-10 space-y-40 pt-52">
        ...
        <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
            <div class="md:flex md:justify-between pt-10">
                <div class="mb-6 md:mb-0">
                    <a href="/" class="flex items-center">
                        <img src="assets/image/Logo Joinedia Mix.png" class="h-20 mr-3" alt="Joinedia Logo" />
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Fast Link</h2>
                    ...
                    <div>
                        <h2 class="mb-6 text-sm font-semibold uppercase cursor-default select-none text-white">Fast Link</h2>
                        <ul class="text-gray-600 dark:text-gray-400">
                            <li class="mb-4">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a
                        href="https://flowbite.com/" class="hover:underline">Joinedia</a>. All Rights Reserved.
                </span>
