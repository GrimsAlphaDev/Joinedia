    ...
    <div class="card d-flex justify-content-center" style="margin:50px; padding:10px;">
        <form action="{{ route('profile.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" aria-label="Default select example" required name="universitas" id="universitas">
            ...
            <div class="mb-3">
                ...
                <input required name="no_telp" id="no_telp" class="form-control"></input>
            </div>
